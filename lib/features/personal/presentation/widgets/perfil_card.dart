// features/personal/presentation/widgets/perfil_card.dart
import 'package:flutter/material.dart';
import 'package:salud_dental_clinic_management/core/presentation/app_colors.dart';
import 'package:salud_dental_clinic_management/features/auth/domain/enums/rol_usuario.dart';
import 'package:salud_dental_clinic_management/features/auth/domain/entities/usuario.dart';
// TODO - SD-37: Importa tu formateador de govID/Cédula real aquí
// import 'package:salud_dental_clinic_management/core/utils/cedula_formatter.dart';
...
class PerfilCard extends StatelessWidget {
  ...
  // Evalúa si el estatus heredado de Persona dice activo
  bool get esActivo =>
    ...
    return Opacity(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            CircleAvatar(
              backgroundColor: _getRolColor(usuario.rol, ac).withOpacity(0.1),
              radius: 22,
              child: Text(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Text(
                        // TODO - SD-37: Envuelve usuario.govID con tu formateador clínico
                        usuario.govID,
                        style: TextStyle(
